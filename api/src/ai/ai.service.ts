    ...
    try {
      ...
      const result = await streamText({
        ...
        onStepFinish: (event) => {
          ...
          console.log(
            '[AI_CHAT] step toolCalls:',
            JSON.stringify(event.toolCalls, null, 2),
          );
          console.log(
            '[AI_CHAT] step toolResults:',
  ...
  private getTools(tenantId?: string) {
    return {
      getDealsSummary: tool({
        description:
          'Get summary statistics of deals and pipeline revenue in the CRM. Can optionally filter by date range.',
        parameters: z.object({
          startDate: z
            .string()
            .optional()
      ...
      getTopDeals: tool({
        description:
          'Get a list of the top deals by value. Optionally filter by stage or date range.',
        parameters: z.object({
          limit: z
            .number()
            .optional()
            .describe('Maximum number of deals to return. Default is 5.'),
          stage: z
            .string()
            .optional()
      ...
      getQuotations: tool({
        description:
          'Get a list of quotations. Can filter by status (e.g. PENDING, APPROVED, DRAFT, SENT).',
        parameters: z.object({
          limit: z
            .number()
            .optional()
            .describe('Maximum number of quotations to return. Default is 5.'),
          status: z
            .string()
            .optional()
            .describe(
      ...
      getLeads: tool({
        description:
          'Get a list of leads. Use this when the user asks for leads, hot leads, or leads to follow up on.',
        parameters: z.object({
          limit: z
            .number()
            .optional()
            .describe('Maximum number of leads to return. Default is 5.'),
          priority: z
            .string()
            .optional()
          ...
          stage: z
            ...
            .optional()
            .describe(
              'Lead stage to filter by (e.g. NEW, CONTACTED, PROPOSAL_SENT)',
            ),
          isConverted: z
            .boolean()
            .optional()
        ...
        execute: async (args: {
          ...
          try {
            ...
            if (isConverted !== undefined)
              whereClause.isConverted = isConverted;
