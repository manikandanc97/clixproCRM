...
export function DashboardSkeleton() {
  return (
    <div className="space-y-6 xl:space-y-8 pb-10 w-full animate-pulse">
      {/* Hero Skeleton */}
      <div className="w-full h-[240px] md:h-[280px] bg-slate-200/50 dark:bg-slate-800/50 rounded-xl mb-8" />
