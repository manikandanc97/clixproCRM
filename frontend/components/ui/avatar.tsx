...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex shadow-sm hover:shadow-md border border-border rounded-lg size-8 data-[size=lg]:size-10 data-[size=sm]:size-6 transition-all select-none shrink-0",
        className,
      )}
      {...props}
    />
...
function AvatarImage({
  ...
  return (
    <AvatarPrimitive.Image
      ...
      className={cn(
        "rounded-lg size-full object-cover aspect-square",
        className,
      )}
      {...props}
    />
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex justify-center items-center bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg size-full font-semibold text-foreground group-data-[size=sm]/avatar:text-xs text-sm",
        className,
      )}
      {...props}
    />
