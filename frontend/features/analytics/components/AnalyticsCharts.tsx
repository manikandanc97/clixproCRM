...
export const LeadsGrowthChart = ({ data, loading }: { data?: LeadsGrowthPoint[], loading?: boolean }) => {
...
export const PipelineOverviewChart = ({ data, loading }: { data?: PipelineStage[], loading?: boolean }) => {
...
export const CustomerGrowthChart = ({ data, loading }: { data?: CustomerGrowthPoint[], loading?: boolean }) => {
...
export const MonthlyPerformanceChart = ({ data, loading }: { data?: RevenuePoint[], loading?: boolean }) => {
...
export const ConversionAnalyticsChart = ({ data, loading }: { 
  data?: { averageRate: string; qualified: string; won: string; target: string; }; 
  loading?: boolean 
}) => {
  return (
