...
const CustomerIntelligenceCard = ({ customer }: CustomerIntelligenceCardProps) => {
  return (
    ...
    >
      <div className="p-8 pt-2 grid grid-cols-1 lg:grid-cols-4 gap-6 bg-muted/50">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-bold text-foreground text-sm uppercase tracking-wider">AI Relationship Summary</h4>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-bold text-foreground text-sm uppercase tracking-wider">Engagement</h4>
          </div>
          <div className="space-y-3">
            <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-bold text-muted-foreground">Total Interactions</span>
              </div>
              <span className="text-sm font-black text-foreground">{customer.totalInteractions || 42}</span>
            </div>
            <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Calendar className="w-4 h-4 text-muted-foreground" />
                <span className="text-xs font-bold text-muted-foreground">Renewal Date</span>
              </div>
              <span className="text-sm font-black text-foreground">{customer.renewalDate || "Dec 12, 2026"}</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-bold text-foreground text-sm uppercase tracking-wider">Predictive Insights</h4>
          </div>
          <div className="space-y-3">
            <div className="bg-card p-4 rounded-xl border border-border shadow-sm">
              <div className="flex justify-between items-center mb-2">
                <span className="text-xs font-bold text-muted-foreground">Churn Risk</span>
            ...
            <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-bold text-muted-foreground">LTV Projection</span>
              </div>
