...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card relative flex flex-col overflow-hidden rounded-lg border border-border bg-card text-card-foreground shadow-card transition-all duration-200",
        hover &&
