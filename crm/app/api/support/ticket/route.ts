...
export async function POST(req: NextRequest) {
  try {
    ...
    if (process.env.SMTP_HOST && process.env.SMTP_USER) {
      ...
      console.log("No SMTP settings found. Simulating email success in development mode.");
      console.log(`Email would be sent to manibct1817@gmail.com for ticket ${ticketId}`);
    }
