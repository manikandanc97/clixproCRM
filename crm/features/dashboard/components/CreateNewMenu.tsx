...
export default function CreateNewMenu() {
  ...
  const actions = [
    ...
    { label: "New Deal", icon: <DollarSign className="w-4 h-4 text-rose-500" />, path: "/pipeline?new=true", color: "hover:bg-rose-500/5 hover:text-rose-600", permission: PERMISSIONS.PIPELINE_CREATE },
