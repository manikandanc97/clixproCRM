...
import { User, Mail, ShieldCheck, Camera, CheckCircle2, Phone, Save, Loader2 } from "lucide-react";
          ...
          <div className="relative group shrink-0">
            <motion.div className="relative">
              <input 
                ...
                className="hidden" 
              />
              <Avatar className="w-20 h-20 rounded-xl border-2 border-border shadow-sm overflow-hidden cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                {avatarPreview ? (
